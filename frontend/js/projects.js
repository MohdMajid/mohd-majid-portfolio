...
function safeUrl(v){const value=String(v||"");if(/^https?:\/\//i.test(value)||value.startsWith("/")||value.startsWith("data:"))return value.replace(/"/g,"&quot;");return ("/"+value.replace(/^\//,"" )).replace(/"/g,"&quot;")}
